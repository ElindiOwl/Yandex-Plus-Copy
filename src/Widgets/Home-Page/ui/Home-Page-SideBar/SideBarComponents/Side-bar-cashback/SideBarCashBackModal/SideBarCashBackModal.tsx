            ...
            <div className='modalCashBack'>
                ...
                <div className='modalContentSideBarCashBack'>
                    ...
                    <button className='close-modal' onClick={onClose}>
                        <svg width='20' height='20' viewBox='5 -5 14 34' fill='none' xmlns='http://www.w3.org/2000/svg'
                             focusable='false' aria-hidden='true' className='SvgIcon' preserveAspectRatio='none'>
